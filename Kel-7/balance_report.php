				...
				<div class="col-md-12">
					<hr>
						<div class="row">
							...
							<button class="btn btn-sm btn-block btn-success col-md-2 ml-1 float-right" type="button" id="print"><i class="fa fa-print"></i>Cetak</button>
							</div>
						</div>
					<div id="report">
						<div class="on-print">
							 <p><center>Laporan Saldo Pembayaran</center></p>
							 <p><center>Sebagai <b><?php echo date('F ,Y') ?></b></center></p>
						</div>
						<div class="row">
