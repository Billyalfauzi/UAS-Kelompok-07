				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<?php endwhile; ?>
								<?php else: ?>
									<option selected="" value="" disabled="">Silahkan lihat Kategori.</option>
								<?php endif; ?>
								</select>
							</div>
							<div class="form-group">
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								...
								<button class="btn btn-sm btn-default col-sm-3" type="reset" >Batal</button>
							</div>
						</div>
					</div>
				</div>
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										<p>Ruangan #: <b><?php echo $row['house_no'] ?></b></p>
										<p><small>Tipe Ruangan: <b><?php echo $row['cname'] ?></b></small></p>
										<p><small>Deskripsi: <b><?php echo $row['description'] ?></b></small></p>
										<p><small>Harga: <b><?php echo number_format($row['price'],2) ?></b></small></p>
									</td>
									<td class="text-center">
										...
										<button class="btn btn-sm btn-danger delete_house" type="button" data-id="<?php echo $row['id'] ?>">Hapus</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
