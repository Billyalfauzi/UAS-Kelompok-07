...
<div class="container-fluid">
    <form action="" id="manage-payment">
        ...
        <div class="form-group">
            <label for="" class="control-label">Penyewa</label>
        ...
        <div class="form-group">
            <label for="" class="control-label">Tagihan: </label>
...
<div id="details_clone" style="display: none">
    <div class='d'>
        <large><b>Detail</b></large>
        <hr>
        <p>Penyewa: <b class="tname"></b></p>
        <p>Harga Sewa Bulanan: <b class="price"></b></p>
        <p>Saldo Hutang: <b class="outstanding"></b></p>
        <p>Total Dibayar: <b class="total_paid"></b></p>
        <p>Sewa Dimulai: <b class='rent_started'></b></p>
        <p>Bayar Bulanan: <b class="payable_months"></b></p>
        <hr>
    </div>
</div>
<script>
