				...
				<div class="col-md-12">
					<form id="filter-report">
						<div class="row form-group">
							<label class="control-label col-md-2 offset-md-2 text-right">Bulan: </label>
					...
					<div id="report">
						<div class="on-print">
							 <p><center>Laporan Pembayaran Rental</center></p>
							 <p><center>Untuk Perbulan  <b><?php echo date('F ,Y',strtotime($month_of.'-1')) ?></b></center></p>
						</div>
						<div class="row">
